...
class EpgScreen extends Component {
  ...
  getCurrentPosition() {
    ...
    return (
      (currentTimeMoment.hours() * MINS_IN_AN_HOUR +
        currentTimeMoment.minutes()) *
      SCALE
    )
  }
  ...
  moveToCurrentPosition() {
    ...
    document.getElementById('timetable__scrollable').scrollLeft =
  ...
  renderNowButton() {
    return (
      <button
        className="timetable__now-button"
        onClick={this.moveToCurrentPosition}
      >
        NOW
      </button>
    )
